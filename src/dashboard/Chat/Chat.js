...
<!-- This is an example component --> */}
      <div class="container mx-auto shadow-lg rounded-lg overflow-hidden p-1">
        {/* <!-- headaer --> */}
    ...
    <!-- Chatting --> */}
        <div class="flex flex-row justify-between bg-white">
          {/* <!-- chat list --> md:hidden block*/}
          <div class="flex flex-col w-2/5 border-r-2 overflow-y-auto  sm:block hidden">
            {/* <!-- search compt --> */}
      ...
      <!-- message --> */}
          ...
          {/* <!-- end message --> */}
          <div class="w-2/5 border-l-2 px-5 hidden sm:block">
            <div class="flex flex-col">
              <div class="font-semibold text-xl py-4">IchahPuron Group</div>
              <img
                src="https://templates.iqonic.design/datum/html/assets/images/logo.png"
                class="object-cover rounded-xl h-64 bg-[#9e9d9d]"
                alt=""
              />
