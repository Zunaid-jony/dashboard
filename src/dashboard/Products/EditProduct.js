...
const EditProduct = () => {
  ...
  useEffect(() => {
    fetch("https://primeautomationapiapi.primeautomaticdoor.com/products")
      .then((res) => res.json())
  ...
  const handleSubmit = async (values) => {
    ...
    try {
      ...
      const anotherApiResponse = await axios.put(
        // http://localhost:5000/
        `https://primeautomationapiapi.primeautomaticdoor.com/products/${product?._id}`,
            ...
            <div className="col-span-9">
              ...
              <div class="col-span-6 sm:col-span-3">
                ...
                >
                  ...
                  <option value="Car_Parking_Barrier">
                    Car Parking Barrier
                  </option>
