                  ...
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th
                        ...
                        className="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6"
                      >
                       <p className="flex"> Name <span className=" ml-2 cursor-pointer">
                      ...
                      >
                        <p className="flex">Email <span className=" ml-2 cursor-pointer">
                        <Link  to="/dashboard/Customer"> 
                      ...
                      <th
                        ...
                        className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
                      >
                <p className="flex">        Location <span className=" ml-2 cursor-pointer">
                <Link  to="/dashboard/Customer"> 
                      ...
                      <th
                        ...
                        className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900"
                      >
                      <p className="flex">  Phone <span className=" ml-2 cursor-pointer">
                      <Link  to="/dashboard/Customer"> 
